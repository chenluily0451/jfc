...
import com.yimei.jfc.core.CoreSupport
...
/**
  ...
  */
trait NotificationService extends CoreSupport {
  ...
  def sendSms(phone: String, templateId: String, vars: Map[String, String]): Future[Boolean] = {
    ...
    params.put("vars", vars.toJson.toString())
    ...
    log.info("发送短信 url[{}], body[{}]", smsUrl, form.toEntity.toString)
