...
module.exports = function (options) {
  ...
  return {
    ...
    entry: {
        ...
        'upstreamRegistration':      AOT ? './src/app/page/upstream/upstreamRegistration.aot.ts' : './src/app/page/upstream/upstreamRegistration.ts',
        'upstreamLogin':      AOT ? './src/app/page/upstream/upstreamLogin.aot.ts' : './src/app/page/upstream/upstreamLogin.ts',
        'upstreamHome':      AOT ? './src/app/page/upstream/upstreamHome.aot.ts' : './src/app/page/upstream/upstreamHome.ts',

        'bridgeRegistration':      AOT ? './src/app/page/bridge/bridgeRegistration.aot.ts' : './src/app/page/bridge/bridgeRegistration.ts',
        'bridgeLogin':      AOT ? './src/app/page/bridge/bridgeLogin.aot.ts' : './src/app/page/bridge/bridgeLogin.ts',

        'capitalRegistration':      AOT ? './src/app/page/capital/capitalRegistration.aot.ts' : './src/app/page/capital/capitalRegistration.ts',
        'capitalLogin':      AOT ? './src/app/page/capital/capitalLogin.aot.ts' : './src/app/page/capital/capitalLogin.ts',

        'platformLogin':      AOT ? './src/app/page/platform/platformLogin.aot.ts' : './src/app/page/platform/platformLogin.ts',
        'platformHome':      AOT ? './src/app/page/platform/platformHome.aot.ts' : './src/app/page/platform/platformHome.ts',
    ...
    plugins: [
      ...
      new CommonsChunkPlugin({
        name: 'vendor',
        chunks: [
            'upstreamRegistration', 'upstreamLogin',
            'bridgeRegistration', 'bridgeLogin',
            'capitalRegistration', 'capitalLogin',
            'platformLogin', 'platformHome',
        ],
      ...
      //   { from: 'src/assets', to: helpers.root('static', 'assets'), }
      // ],
      ...
      //   template: 'src/app/page/upstream/upstreamRegistration.html',
